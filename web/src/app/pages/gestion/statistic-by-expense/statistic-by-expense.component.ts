...
@Component({
  selector: 'app-statistic-by-expense',
  standalone: false,
  templateUrl: './statistic-by-expense.component.html',
  styleUrl: './statistic-by-expense.component.scss'
})
export class StatisticByExpenseComponent implements OnInit{
  ...
  getStatistics() {
    ...
    this.stats = [];
    this.budget_service.getBudgetStatisticsByExpense(this.stat_form.value).subscribe({
      next: (v: any) => {
